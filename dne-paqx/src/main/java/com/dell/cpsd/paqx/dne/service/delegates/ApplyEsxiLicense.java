...
public class ApplyEsxiLicense extends BaseWorkflowDelegate
{
    ...
    public void delegateExecute(final DelegateExecution delegateExecution)
    {
        ...
        if (StringUtils.isNotEmpty(hostname))
        {
            ...
            {
                LOGGER.error("Apply Esxi License on Node " + nodeDetail.getServiceTag() + " failed!");
                updateDelegateStatus("Apply Esxi License on Node " + nodeDetail.getServiceTag() + " failed!");
                updateWorkflowErrorResult(true, delegateExecution);
                throw new BpmnError(APPLY_ESXI_LICENSE_FAILED,
                                    "Apply Esxi License on Node " + nodeDetail.getServiceTag() + " failed!");
            }
