    ...
    */
    ...
    public void delegateExecute(final DelegateExecution delegateExecution)
    {
        ...
        if (nodeDetail != null && StringUtils.isNotEmpty(nodeDetail.getId()) && StringUtils.isNotEmpty(
                nodeDetail.getEsxiManagementIpAddress()) && StringUtils.isNotEmpty(
                nodeDetail.getEsxiManagementGatewayIpAddress()) && StringUtils.isNotEmpty(
                nodeDetail.getEsxiManagementSubnetMask()))
        {
