 ...
 */
     ...
     */
    public <RES extends ServiceResponse<?>> AsynchronousNodeServiceCallback<RES> processRequest(final String processInstanceId,
                                                                                                final String activityId,
                                                                                                final String messageId,
                                                                                                long timeout,
                                                                                                ServiceRequestCallback serviceRequestCallback) throws ServiceTimeoutException, ServiceExecutionException {
        this.shutdownCheck();
        ...
        AsynchronousNodeServiceCallback<RES> serviceCallback = new AsynchronousNodeServiceCallback(processInstanceId, activityId, messageId, runtimeService);
            ...
            throws ServiceExecutionException
    {
        ...
        if (responseCallback != null)
        {
            ...
            Object responseMessage = responseCallback.getServiceResponse();
